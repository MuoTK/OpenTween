...
namespace OpenTween.Properties {
    ...
    internal class Resources {
        ...
        ///   更新履歴
        ///
        ///==== Ver 1.0.1.3.0(2015/06/05)
        ///* NEW: モールス符号化機能を追加
        ///
        ///==== Ver 1.0.1.2.2(2015/06/04)
        ///* CHG: フォーマットに dev を増やした
        ///
        ///==== Ver 1.0.1.2.1(2015/06/04)
        ///* CHG: バージョンのフォーマットを変更
        ///
        ///==== Ver 1.0.1.2.0(2015/06/04)
        ///* CHG: アセンブリ名を OpenTweenAC に
        ///* CHG: OpenTweenAC の permission を Read, Write and Access direct messages に変更
        ///* NEW: Ctrl+C を STOT 形式ではなく本文のみのコピーへ
        ///
        ///==== Ver 1.0.1.1(2015/06/01)
        ///* OpenTween のコンシューマーキーから OpenTweenA の変更 に類似しているローカライズされた文字列を検索します。
        /// </summary>
